...
const PRE_V0130_BACKUP_KEY = 'lingshan_save_backup_pre_v0130';
...
export class SaveSystem {
  ...
  load(): GameStateData | null {
    try {
      ...
      if (oldSchema < SCHEMA_VERSION && !localStorage.getItem(PRE_V0130_BACKUP_KEY)) {
        localStorage.setItem(PRE_V0130_BACKUP_KEY, s);
      }
